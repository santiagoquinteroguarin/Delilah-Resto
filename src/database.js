...
// pool - hilos que se ejecutan como tareas en secuencia , funciona con collbacks
...
pool.getConnection((err, connection) => {
    ...
    // release -- inicia la conexion
    if(connection) connection.release();
    console.log('DB is Connected');
    return;
});

// todos los metodos que empiecen por query cada vez que utilice un query ya puedo utilizar promesas y async await
